...
// my API KEY
var ApiLocation = "3fb726164f694e7d96c34f856af327c4";
...
//day1
        ...
        var tempMax1 = Math.round(d.data[0].max_temp);
        var tempMin1 = Math.round(d.data[0].min_temp);
...
//draw the chart with main temp and date
        ...
        var myChart = new Chart(ctx, {
            ...
            type: 'line',
            data: {
                labels: [setDate(day1), setDate(day2), setDate(day3), setDate(day4), setDate(day5)],
                datasets: [{
